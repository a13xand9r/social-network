...
import { requestProfilePage, getUserStatus, updateUserStatus, savePhoto } from '../../../redux/profile_reducer';
...
export default compose(
    connect(mapStateToProps, {requestProfilePage, getUserStatus, updateUserStatus, savePhoto}),
    withRouter,
    withAuthRedirect
)(ProfileContainer)